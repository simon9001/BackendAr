    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary_en', models.TextField(blank=True, max_length=1000, null=True)),
                ('summary_fr', models.TextField(blank=True, max_length=1000, null=True)),
                ('summary_es', models.TextField(blank=True, max_length=1000, null=True)),
                ('summary_ru', models.TextField(blank=True, max_length=1000, null=True)),
